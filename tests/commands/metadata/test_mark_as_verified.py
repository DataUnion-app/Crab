...
class TestMarkAsVerified(TestBase):
    ...
    def test_query_metadata_4(self):
        ...
        verify_image_command.execute()
        self.assertFalse(verify_image_command.successful)
        self.assertListEqual(['Length of tag(s) exceeds limit of [200] characters.'], verify_image_command.messages)
        ...
        self.assertListEqual(['Length of description(s) exceeds limit of [2000] characters.'],
    ...
    def test_query_metadata_5(self):
        ...
        verify_image_command.execute()
        self.assertFalse(verify_image_command.successful)
        self.assertListEqual(['Tags contains banned word(s)'],
